...
\begin{frame}{Qubits}
        ...
        \end{itemize}
        \begin{figure}
            \only<1>{\includegraphics[width=0.9\linewidth, height=0.45\textheight]{figures/technologies.jpg}}%
            \only<2>{\includegraphics[width=0.5\linewidth, height=0.45\textheight]{figures/pulses.png}}%
            \only<3>{\includegraphics[width=0.75\linewidth, height=0.45\textheight]{figures/vqc_2.png}}
            \only<4>{\includegraphics[width=0.75\linewidth, height=0.45\textheight]{figures/vqc.png}}
        \end{figure}        
\end{frame}
...
\begin{figure}
   \includegraphics[width=1\linewidth]{figures/vqc.png}
\end{figure}  
\end{frame}
